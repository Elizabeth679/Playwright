...
test.only('automation of shopping cart web application using page object model',async({page})=>{
...
customtest('page playwright customised test',async({page,testDataForOrder})=>{
    let pomanager=new Pomanager(page);
    let login=pomanager.getLogin();
    await login.goto();
